...
<div class="container detalle-individual">
...
<br>
  ...
  <br>
    ...
    <div id="div-producto{{$caca->name}}">
      <div class="row">
        <div class="col-sm-5" id="div-producto{{$caca->name}}">
          @if (session('mensaje'))
      ...
      <img src="/storage/{{$caca->avatar}}" class="detalle-img" alt="...">
