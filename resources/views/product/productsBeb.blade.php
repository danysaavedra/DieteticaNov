...
<div style="display:flex" class="botoncat">
  ...
  <div class="dropdown-menu" aria-labelledby="dropdownMenuLink">
    <a class="dropdown-item" href="/productos/detallesSub/beb/sinAlcohol">Con Alcohol</a>
    <a class="dropdown-item" href="/productos/detallesSub/beb/alcohol">Sin Alcohol</a>
  </div>
</div>
</div>
...
@if(isset($productos))
 ...
 @if($product->dameSubCategoria()   == "Bebidas")
